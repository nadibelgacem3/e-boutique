...
export class CollectionLeftSidebarComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private router: Router,private articleService: ArticleService,
        ...
        this.route.queryParams.subscribe(params => {
            ...
            this.size = params.variant ? params.variant.split(',') : [];
            ...
            this.productService.filterProducts(this.tags).subscribe(response => {
                this.productService.cartItems.subscribe(res2 => {
                })
                // Sorting Filter
    ...
    ngOnInit(): void {
        ...
        this.articleService.maxMinPriceCategory(schemaName).subscribe(res => {
            if (res.max_ttc_priceCategory) {
                this.maxPrice = res.max_ttc_priceCategory;
            }
        });
    }
    ...
    removeTag(tag) {
        ...
        let params = {
            ...
            variant: this.size.length ? this.size.join(',') : null
        };
