...
@Component({
  selector: 'app-profile-bill',
  templateUrl: './profile-bill.component.html',
  styleUrls: ['./profile-bill.component.scss']
})
export class ProfileBillComponent implements OnInit {
